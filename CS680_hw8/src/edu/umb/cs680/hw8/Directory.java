...
//        src.RemoveChild(java2);
        ...
        Link link1 = new Link(root,"src",0,LocalDateTime.now(),src);
        Link link2 = new Link(src,"Helloworld",3,LocalDateTime.now(), java2);
        root.appendChild(link1);
        System.out.println(link1.getTarget().name);
        System.out.println(link1.getParent().name);
        link1.removeLink();
        System.out.println(link2.getSize());
        System.out.println(link1.getSize());
        System.out.println(root.getSubDirectories().size());
